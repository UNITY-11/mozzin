        ...
        >
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center">
              <span className="font-syncopate mx-8 bg-gradient-to-t from-blue-500 to-white bg-clip-text text-[22vw] leading-none font-black tracking-tighter text-transparent opacity-90 md:text-[14vw]">
                BRANDING
              </span>
              <svg
