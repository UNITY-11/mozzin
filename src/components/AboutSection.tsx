          ...
          <div className="flex w-full max-w-[1500px] flex-col gap-12 lg:flex-row lg:gap-24">
            ...
            >
              <div className="relative mb-8 grid w-full">
                ...
                <p
                  ref={p1Ref}
                  className="col-start-1 row-start-1 w-full bg-clip-text text-2xl leading-relaxed font-light text-transparent opacity-0 md:text-3xl lg:text-[32px] lg:leading-[1.4]"
                  style={{
                    backgroundImage:
                ...
                <p
                  ref={p2Ref}
                  className="col-start-1 row-start-1 w-full bg-clip-text text-xl leading-relaxed font-light text-transparent opacity-0 md:text-2xl lg:text-[24px] lg:leading-[1.5]"
                  style={{
                    backgroundImage:
                      'linear-gradient(to bottom, white calc(var(--reveal-pct, -20%) - 20%), #1f2937 calc(var(--reveal-pct, -20%) + 20%))',
                  }}
