...
export default function ExpertiseSection() {
  ...
  return (
    <section className="relative z-20 bg-[#01030a] py-24 lg:py-32 overflow-hidden border-t border-white/5">
      {/* Background ambient glow */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
...
function ExpertiseCard({ item, index, isVisible }: { item: typeof expertiseData[0], index: number, isVisible: boolean }) {
  ...
  return (
    <div
      ...
      className={`group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-8 transition-all duration-1000 hover:border-white/20 hover:bg-white/[0.04] ${
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-400 transition-transform duration-500 group-hover:scale-110 group-hover:bg-blue-500/20 group-hover:text-blue-300">
          {item.icon}
        </div>
        <h4 className="mb-3 font-syncopate text-lg font-bold tracking-wide text-white transition-colors duration-300 group-hover:text-blue-400">
          {item.title}
        </h4>
